...
void main()
{
    ...
    if (case_num == 1)
    {
        ...
        // 材料路径
        std::string path = "E:\\WH_CAE\\test_model\\modefy.inp";
        // 关键字
        ...
        // 执行结构响应分析
        string result_path = "E:\\WH_CAE\\test_model\\output\\full_modefy.vtk";
        string path_abaqus = "E:\\WH_CAE\\test_model\\NLFEA.txt";
    ...
    else if (case_num == 2)
    {
        ...
        CAE::elastic_mat mat_item{2.1e5, 0.3, 7800};
        // 材料路径
        std::string path = "E:\\WH_CAE\\test_model\\original.inp";
        // 关键字
        string load_set_keyword = "Set-load";
        string load_value_keyword = "Cload";
        string dis_set_keyword = "Set-fix";
